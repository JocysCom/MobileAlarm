...
namespace JocysCom.MobileAlarm.Server.Droid
{
	[Activity(Label = "JocysCom.MobileAlarm.Server", Icon = "@mipmap/icon", Theme = "@style/MainTheme", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
